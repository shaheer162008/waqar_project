...
export function SectionTracker({
  ...
  return (
    <Card
      className={cn(
        className,
        "fixed top-40 right-10 w-80 h-[350px] overflow-y-auto rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 shadow-xl p-6 border border-gray-300 hover:shadow-2xl transition-shadow duration-300"
      )}
    >
